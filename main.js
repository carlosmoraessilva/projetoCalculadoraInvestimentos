...
function renderProgression(evt) {
  ...
  doughnutChartReference = new Chart(finalMoneyChart, {
    ...
    data: {
      ...
      datasets: [
        {
          //  label: "Gráfico de investimentos",
          data: [
...
function validateInput(evt) {
  ...
  if (
    ...
    if (!parentElement.classList.contains("error")) {
      ...
      errorElement.innerText = "Insira um valor numérico e maior que zero";
      parentElement.classList.add("error");
      grandParentElement.appendChild(errorElement);
    }
  } else if (
    parentElement.classList.contains("error") &&
    !isNaN(inputValue) &&
    ...
    const errorMsg = grandParentElement.querySelector("p.text-red-500");
...
nextButton.addEventListener("click", () => {
  carouselEl.scrollLeft += mainEl.offsetWidth;
});
